...
namespace Abp.Taxi.Migrations
{
    ...
    [Migration("20230725154335_Driver_Booking_Passenger")]
    partial class DriverBookingPassenger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Taxi.Bookings.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Taxi.CarModels.CarModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Taxi.Cars.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppCars", (string)null);
                });

            modelBuilder.Entity("Abp.Taxi.Drivers.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Taxi.Manufacturers.Manufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Taxi.Passengers.Passenger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Taxi.Bookings.Booking", b =>
                {
                    b.HasOne("Abp.Taxi.Cars.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId");

                    b.HasOne("Abp.Taxi.Drivers.Driver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId");

                    b.HasOne("Abp.Taxi.Passengers.Passenger", "Passenger")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Abp.Taxi.CarModels.CarModel", b =>
                {
                    b.HasOne("Abp.Taxi.Manufacturers.Manufacturer", "Manufacturer")
                        .WithMany("CarModels")
            ...
            modelBuilder.Entity("Abp.Taxi.Cars.Car", b =>
                {
                    b.HasOne("Abp.Taxi.CarModels.CarModel", "CarModel")
                        .WithMany()
